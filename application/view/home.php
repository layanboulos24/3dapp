...
<body>
    ...
    <div class="card rounded img-thumbnail mx-auto mt-5" id="slideshow" style="max-width: 95%;">
        <!-- <img class="imgBox img-fluid img-thumbnail card mx-auto mt-5" src='/3dapp/assets/images/coke_brands.jpg' style="max-width: 95%;"> -->
